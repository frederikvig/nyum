...
size: 12 servings
time: 40 minutes
source: https://cooking.nytimes.com/recipes/1019593-baked-apple-cider-doughnuts
favorite: ✓
vegan: ✓
sweet: ✓
---
...
* `10 tbsp (141g)` unsalted butter, at room temperature
* `¾ cup (165g)` light brown sugar
* `¼ cup (50g)` granulated sugar
* `2` large eggs, at room temperature
* `1 tsp` vanilla extract
* `½ cup (120ml)` apple cider, spiced preferred
